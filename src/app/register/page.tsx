        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#2d2f34] px-10 py-3">
          ...
          <div className="flex flex-1 justify-end gap-8">
            ...
            <div className="hidden md:flex gap-2">
              <Link href="/login" className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#2d2f34] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#2d2f34]/90 transition-all duration-200">
          ...
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              ...
              <p className="text-white text-base font-normal leading-normal">
                Start your creative journey with faith-driven tools
              </p>
            </div>
            ...
            <div className="bg-[#131416]/30 border border-[#2d2f34] rounded-xl p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center">
                  <input type="checkbox" className="rounded border-[#2d2f34] text-[#b7c6e0] focus:ring-[#b7c6e0]" required />
                  <span className="ml-2 text-white text-sm">
                    I agree to the{' '}
                    <Link href="/terms" className="text-[#b7c6e0] hover:underline">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link href="/privacy" className="text-[#b7c6e0] hover:underline">
                      Privacy Policy
                    </Link>
                  </span>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-white text-sm">
                  ...
                  <Link href="/login" className="text-[#b7c6e0] hover:underline">
                    Sign in
                  </Link>
                </p>
              </div>
